                ...
                <div class="page-inner">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Add Orgnization(s)</div>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <div class="card-title">Orgnization(s)</div>
                                </div>
                                <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-button-action">
                                                        <a class="m-r-15" data-toggle="modal" data-target="#viewRModal"><i class="fa fa-eye icon-primary"></i></a>
                                                        <a class="m-r-15" data-toggle="modal" data-target="#viewEModal"><i class="fa fa-edit icon-primary"></i></a>
                                                        <a class="m-r-15 delete-data"><i class="fa fa-times icon-danger"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
